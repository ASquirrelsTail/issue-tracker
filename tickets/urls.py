...
from tickets.views import (TicketsListView, TicketView, AddBugView, AddFeatureView, SetTicketStatusView, AddCommentView,
                           ...
                           AddLabelView, EditLabelView, DeleteLabelView, DeleteCommentView)
...
urlpatterns = [
    ...
    url(r'^(?P<ticket_pk>[0-9]+)/comments/(?P<pk>[0-9]+)/delete/$', DeleteCommentView.as_view(), name='delete-comment'),
