...
from issues.views import IssuesListView, IssueView, AddIssueView, SetIssueStatusView, AddCommentView, EditCommentView
...
urlpatterns = [
    ...
    url(r'^(?P<issue_pk>[0-9]+)/comments/(?P<comment_pk>[0-9]+)/add/$', AddCommentView.as_view(), name='add-reply'),
